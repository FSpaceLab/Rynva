...
float HTU21D::readHumidity(HTU21D_HUMD_OPERATION_MODE sensorOperationMode)
{
  ...
  #else
  Wire.requestFrom(HTU21D_ADDRESS, 3, 1);                   //true, stop message after transmission & releas the I2C bus
  #endif
...
float HTU21D::readTemperature(HTU21D_TEMP_OPERATION_MODE sensorOperationMode)
{
  ...
  #else
  Wire.requestFrom(HTU21D_ADDRESS, qntRequest, 1);                                         //true, stop message after transmission & releas the I2C bus
  #endif
...
uint8_t HTU21D::readFirmwareVersion(void)
{
  ...
  #else
  Wire.requestFrom(HTU21D_ADDRESS, 1, 1); //true, stop message after transmission & releas the I2C bus
  #endif
